...
export const PHOTO = {
  ...
  radius: 0.070,
  /**
   * 地に沈める濃さ。0.34では写真が前へ出すぎた（実測）。
   * **縁は引かない** ―― 薄い写真の右脇に縦の線が立って見えたため（指摘）。
   */
  opacity: 0.22,
  /** 3枚だけ（指定）。多いと地が騒がしくなる */
  slots: [
    { cx: 0.46, cy: 0.175, rot: 4 },
    { cx: 0.145, cy: 0.375, rot: -7 },
    { cx: 0.375, cy: 0.560, rot: 5 },
  ],
} as const;
